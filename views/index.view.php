...
<html lang="es">
    ...
    <body>
        ...
        <div class="agrupar">
            ...
            <!-- Inicia Formulario para btn Submit -->
                    ...
                    <article> <!-- Articulo de bienvenida -->
                        ...
                        <div class="formulario"> <!-- Este Div contiene todas las preguntas -->
                            ...
                            <p>1. Overall experience with Canteiro Weddings sales specialist:</p>
                                <div class="checkbox">
                                    <!-- Excelent -->
                                    <input type="radio" id="p1excel" name="p1" value="excellent" checked>
                            ...
                            <p>2. How do you rate the quality of the furniture & décor items?</p>
                                <div class="checkbox">
                                    <!-- Excelent -->
                                    <input type="radio" id="p2excel" name="p2" value="excellent" checked>
                            ...
                            <div class="checkbox">
                                <!-- Excelent -->
                                <input type="radio" id="p3excel" name="p3" value="excellent" checked>
                            ...
                            <div class="checkbox">
                                <!-- Excelent -->
                                <input type="radio" id="p4excel" name="p4" value="excellent" checked>
                                ...
                                <!-- Average -->
                                <input type="radio" id="p4average" name="p4" value="average">
                            ...
                            <!-- Boton Guardar -->
                            <input class="boton" type="submit" value="Send Survey">
                        </div>
                </section>
